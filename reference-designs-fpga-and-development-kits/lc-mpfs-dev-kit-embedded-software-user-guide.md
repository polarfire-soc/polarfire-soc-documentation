...
The root password is “microchip” for Buildroot & Yocto `mchp-base-image`. No password is set for Yocto `core-image*`. The console should look similar to the following figure.

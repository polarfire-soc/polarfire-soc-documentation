...
- How To
  ...
  - [Linux Boot Authentication](./linux-boot-authentication.md)
  ...
  - [Re-programming the FPGA from Linux](./re-programming-the-fpga-from-linux.md)
  - [Using U-Boot to TFTPboot a bare metal ELF](./tftpboot-with-uboot.md)
  - [Cryptography with OpenSSL](./cryptography-with-openssl.md)

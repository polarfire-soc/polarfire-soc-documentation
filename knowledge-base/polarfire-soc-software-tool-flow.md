...
![PolareFire SoC software full tool flow](./images/polarfire-soc-software-tool-flow/tool-flow-full.svg)
...
![FPGA design and Linux image programming flow](./images/polarfire-soc-software-tool-flow/tool-flow-fpexpress-linux.svg)
...
![FPGA design, Linux image and bare-metal programming flow](./images/polarfire-soc-software-tool-flow/tool-flow-fpexpress.svg)
...
![Full TCL design flow](./images/polarfire-soc-software-tool-flow/tool-flow-full.svg)
...
![Full design flow](./images/polarfire-soc-software-tool-flow/tool-flow.svg)
...
1. Create a new FP Express job:
    ...
    ![FlashPro new job window](./images/polarfire-soc-software-tool-flow/fpexpress-job.png)
...
![Libero TCL script completion log](./images/polarfire-soc-software-tool-flow/tcl-complete.png)

The design can be configured further if required by editing the SmartDesigns created:

![Libero SmartDesigns view](./images/polarfire-soc-software-tool-flow/smartdesigns.png)

The design flow can then be run from the left hand side:

![Libero design flow](./images/polarfire-soc-software-tool-flow/design-flow.png)
...
4. This will display the default configuration for the Icicle Kit which can be modified as required:
    ...
    ![HSS menuconfig](./images/polarfire-soc-software-tool-flow/hss-default.png)
...
2. In SoftConsole select File -> Import and then select General/Existing Projects into Workspace:
    ...
    ![SoftConsole import window](./images/polarfire-soc-software-tool-flow/sc-import.png)

3. Navigate to the HSS repository and select finish to import the project:

    ![SoftConsole import projects window](./images/polarfire-soc-software-tool-flow/import-project.png)
...
4. Place the HSS configuration file in the top level directory naming it solely ".config", the default configurations can be used from the boards folder for each target:
    ...
    ![SoftConsole def config files](./images/polarfire-soc-software-tool-flow/def-config.png)
...
5. Build the HSS "Default" build configuration:
    ...
    ![SoftConsole build HSS default](./images/polarfire-soc-software-tool-flow/hss-build.png)
...
![SoftConsole program eNVM](./images/polarfire-soc-software-tool-flow/envm-program.png)

...
You can organize the content of this folders as best fits your preference or keep your application code in another location.
...
For more information on the Libero and the MSS Configurator tool, pleaser refer to the [Tool Flow](https://github.com/polarfire-soc/polarfire-soc-documentation/blob/master/software-development/polarfire-soc-software-tool-flow.md#tool-flow)
